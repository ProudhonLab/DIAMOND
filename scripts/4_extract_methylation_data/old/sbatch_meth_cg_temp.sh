...
sbatch -W --cpus-per-task=10 --mem=50G -o ${outputDir}/logs/extract_methyl-%A_%a.out --array=0-${nbJobs}%8 scripts/3_extract_methylation_data/slurm_meth_cg_temp.sh ${inputDir} ${outputDir}
