...
python ${baseDir}/methylation_haplotypes_cluster_ver.py -a -p "${primer}" --cg_methyl ${inputAlign} > ${outputDir}/allSamples.${primer}.methylation_vs_cg.csv
...
python ${baseDir}/methylation_haplotypes_cluster_ver.py -a -p "${primer}" --cg_methyl --include_all ${inputAlign} > ${outputDir}/allSamples.${primer}.methylation_vs_all.csv