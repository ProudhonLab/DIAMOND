...
sbatch -W --cpus-per-task=10 --mem=50G -o ${outputDir}/logs/extract_haplo-%A_%a.out --array=0-${nbJobs}%8 scripts/3_extract_methylation_data/slurm_haplo_all_temp.sh ${inputDir} ${outputDir}
