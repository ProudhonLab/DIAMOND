...
# October 4th, 2023 #
#####################
# We want to do classifications after adding new HD samples in C2 (30 pools)
...
workDir_d = paste0("/scratch/",user,"/20231004_classification_with_30pools_in_C2_DX_samples/discovery/inputs/")
workDir_v = paste0("/scratch/",user,"/20231004_classification_with_30pools_in_C2_DX_samples/validation/inputs/")
...
c2_infos_mhovc25 = infos_all[which((infos_all$mhovc == "mhovc25" & infos_all$type == "plasma" & infos_all$patient_cohort == "DX_biosamples") | (infos_all$mhovc == "mhovc25" & infos_all$type == "plasma" & infos_all$class != "healthy")),]
