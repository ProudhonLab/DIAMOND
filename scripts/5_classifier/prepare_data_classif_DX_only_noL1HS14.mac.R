...
# October 17th, 2023 #
#####################
# We want to do classifications after adding DX only whithout S020, S021, S028, S038, S039 + NO L1HS14
...
workDir_d = paste0("/scratch/",user,"/20231017_classification_Dx_nol1hs14/discovery/inputs/")
workDir_v = paste0("/scratch/",user,"/20231017_classification_Dx_nol1hs14/validation/inputs/")
...
c2_infos_mhovc25 = infos_all[which((infos_all$mhovc == "mhovc25" & infos_all$type == "plasma" & infos_all$patient_cohort == "DX_biosamples") | (infos_all$mhovc == "mhovc25" & infos_all$type == "plasma" & infos_all$class != "healthy" & infos_all$paper_cohort == "validation")),]
...
c2d_methyl = c2d_methyl[,-grep("L1HS_14",colnames(c2d_methyl))]


c2_methyl = rbind(c2_methyl,c2d_methyl)
