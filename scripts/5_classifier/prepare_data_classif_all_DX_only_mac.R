...
# October 6th, 2023 #
#####################
# We want to do classifications after adding DX only
...
workDir_d = paste0("/scratch/",user,"/20231006_classification_with_DX_samples_only/discovery/inputs/")
workDir_v = paste0("/scratch/",user,"/20231006_classification_with_DX_samples_only/validation/inputs/")
