...
workDir_d = paste0("/scratch/",user,"/20231004_classification_with_30pools_in_C2/discovery/inputs/")
workDir_v = paste0("/scratch/",user,"/20231004_classification_with_30pools_in_C2/validation/inputs/")
...
c1d_methyl = c1d_methyl [rownames(infos_eUVM),-grep("L1HS_15",colnames(c1d_methyl))]
...
c2_infos_mhovc25 = infos_all[which((infos_all$mhovc == "mhovc25" & infos_all$type == "plasma" & infos_all$class != "healthy")),]
