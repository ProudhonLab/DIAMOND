...
# October 16th, 2023 #
##################
# We want to do classificationswith haplotype only + Dx only
...
workDir_d = paste0("/scratch/",user,"/20231016_classification_haplotype_Dx/discovery/inputs/")
workDir_v = paste0("/scratch/",user,"/20231016_classification_haplotype_Dx/validation/inputs/")
...
#haplo_mhovc25 = read.csv("Test_classif/haplotypes.all_samples.csv")
...
#c2_infos = read.csv("Test_classif/c2_plasma_samples_info.csv")
...
#haplo_c2 = read.csv("Test_classif/haplotypes.c2.csv")
...
c2_methyl = rbind(haplo_c2[,-1], c2d_haplo)
