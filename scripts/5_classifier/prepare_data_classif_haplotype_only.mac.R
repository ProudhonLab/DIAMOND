...
# October 11th, 2023 #
##################
# We want to do classificationswith haplotype only 
...
workDir_d = paste0("/scratch/",user,"/20231009_classification_haplotype_only_mac/discovery/inputs/")
workDir_v = paste0("/scratch/",user,"/20231009_classification_haplotype_only_mac/validation/inputs/")
