...
# October 6th, 2023 #
#####################
# We want to do classifications after adding DX only whithout S020 and S021
...
workDir_d = paste0("/scratch/",user,"/20231006_classification_Dx_only/discovery/inputs/")
workDir_v = paste0("/scratch/",user,"/20231006_classification_Dx_only/validation/inputs/")
