...
##############################################
# POOLS IN DISCOVERY + MHOVC25 IN VALIDATION #
##############################################

workDir_d = paste0("/scratch/",user,"/20231009_classification_pool_dicovery_and_MHOVC25_validation/discovery/inputs/")
workDir_v = paste0("/scratch/",user,"/20231009_classification_pool_dicovery_and_MHOVC25_validation/validation/inputs/")
...
# Ajout des 30 pools en discovery
...
c1e_methyl = methyl[which(methyl$method=="Mn"),1:32]
