...
workDir_d =  paste0("/scratch/",user,"/20231003_classification_with_30pools_in_C2_all_mhovc/discovery/inputs/")
workDir_v =  paste0("/scratch/",user,"/20231003_classification_with_30pools_in_C2_all_mhovc/validation/inputs/")
